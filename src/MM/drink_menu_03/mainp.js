    ...
    return (
        <div className="App">
            ...
            <Card.Body>
                ...
                <Content contents={products} onClickToContent={ClickArrived} select={selected} />
            </Card.Body>
            <Card.Body>
                <Switcher mode={mode} productitem={getProductById()} />
            </Card.Body>
            <Card.Footer>
                <Bottom onClickToBottom={ModeSelected} />
            </Card.Footer>
            <Card.Footer>
                //table + mode +insert
            </Card.Footer>
